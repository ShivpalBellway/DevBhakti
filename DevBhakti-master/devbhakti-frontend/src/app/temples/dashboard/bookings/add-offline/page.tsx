...
import { fetchMyTempleBookings } from "@/api/templeAdminController";
...
export default function TempleOfflinePoojaPage() {
    ...
    const loadBookings = async () => {
        setIsLoading(true);
        try {
            const response = await fetchMyTempleBookings();
            if (response.success) {
    ...
    const handlePrintReceipt = (booking: any) => {
        const receiptData = {
            ...
            templeName: booking.temple?.name ? parseLocalizedValue(booking.temple.name) : "DevBhakti Temple",
    ...
    const handleExportExcel = () => {
        ...
        XLSX.writeFile(wb, `Temple_Offline_Pooja_${new Date().toISOString().slice(0,10)}.xlsx`);
    };
        ...
        <div className="w-full max-w-7xl mx-auto space-y-6 pb-20 px-2 sm:px-0">
            ...
            <div className="flex items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-3">
                    <Button onClick={handleExportExcel} variant="outline" className="border-amber-800/20 hover:bg-amber-800/5 text-amber-800 shadow-sm rounded-xl">
            ...
            <div>
                ...
                <p className="text-sm text-slate-500">View, manage, and record manual pooja bookings for your temple.</p>
            </div>
                ...
                <CardContent className="p-4 flex flex-col md:flex-row gap-3 items-center justify-between">
                    <div className="relative w-full md:max-w-md">
                        ...
                        <Input
                            ...
                            className="pl-9 rounded-xl border-slate-200 focus:border-amber-800"
                        />
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
                        <div className="flex items-center gap-2">
                            ...
                            <select
                                ...
                                className="border border-slate-200 rounded-xl px-3 py-2 text-sm bg-white text-slate-700 focus:outline-none focus:ring-2 focus:ring-amber-800/20"
                            >
                ...
                <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4" onClick={() => setSelectedBooking(null)}>
                    <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full max-h-[85vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="p-4 border-t flex gap-3">
                            ...
                            <Button onClick={() => setSelectedBooking(null)} className="flex-1 bg-amber-800 hover:bg-amber-900 text-white rounded-xl">
                                Close
                            </Button>
                        </div>
                    </div>
