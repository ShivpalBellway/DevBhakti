      ...
      <section className="bg-gradient-to-br from-primary/10 via-secondary/20 to-background pt-24 pb-12">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl font-display font-bold text-foreground">
            {selectedPoojaData ? t("booking_client.book_prefix") + parseLocalizedValue(selectedPoojaData.name, language) : t("booking_client.book_default")}
          </h1>
          <p className="text-muted-foreground mt-2">
            {selectedPoojaData ? t("booking_client.complete_prefix") + parseLocalizedValue(selectedPoojaData.name, language) : t("booking_client.complete_default")}
          </p>
        </div>
      </section>
