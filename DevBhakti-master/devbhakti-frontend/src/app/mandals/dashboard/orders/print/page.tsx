...
import { fetchMandalOrders, fetchMandalProfile } from "@/api/mandalAdminController";
                                ...
                                <div className="column col-border">
                                    ...
                                    <div className="column-content">
                                        <div style={{ marginBottom: 0 }}>
                                            <strong>{parseLocalizedValue(mandalData?.name, language) || parseLocalizedValue(order.mandal?.name, language) || "DevBhakti Seller"}</strong><br />
                                            {parseLocalizedValue(mandalData?.location, language) || parseLocalizedValue(order.mandal?.fullAddress, language) || "Indore, MP"}
                                        </div>
                                        <br />
                            ...
                            <div className="totals-section">
                                <div className="totals-left">
                                    ...
                                    <div className="footer-sign">
                                        ...
                                        {parseLocalizedValue(mandalData?.name, language) || parseLocalizedValue(order.mandal?.name, language) || "DevBhakti Seller"}
                                    </div>
                                </div>
...
export default function MandalPrintLabelsPage() {
    return (
