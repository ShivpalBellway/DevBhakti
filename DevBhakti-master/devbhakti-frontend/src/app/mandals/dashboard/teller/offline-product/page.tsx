        ...
        return `
            ...
            <body>
                <div class="receipt-card">
                    <div class="header">
                        <h1 class="title">${mandalName || "DevBhakti Mandal"}</h1>
                    ...
                    <div class="footer">
                        <p>Thank you for your purchase! This is a computer-generated receipt.</p>
                    </div>
                </div>
            </body>
            </html>
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                        Create an offline order for {mandalName}
                    </p>
                </div>
            </div>
