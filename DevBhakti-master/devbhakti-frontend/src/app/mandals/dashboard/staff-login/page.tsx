...
import { Mail, Lock, ArrowRight, ShieldCheck, Flag, Eye, EyeOff, CheckCircle2 } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";
import { useRouter } from "next/navigation";
import { staffLoginMandal } from "@/api/mandalAdminController";
import { clearAllTokens } from "@/lib/auth-utils";

export default function MandalStaffLoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            const response = await staffLoginMandal(form);
            ...
            if (response.success) {
                ...
                // Also set general 'user' for layout hooks
                    ...
                    <div className="p-8 md:p-12">
                        ...
                        <div className="flex flex-col items-center text-center mb-10">
                            ...
                            <p className="text-slate-500 max-w-xs mx-auto text-sm">
                                Portal access for authorized Mandal team members & volunteers.
                            </p>
                        </div>
