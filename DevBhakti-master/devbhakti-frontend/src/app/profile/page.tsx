...
const ProfilePage = () => {
    ...
    const handleUpdate = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast({
                title: t('profile.messages.fail_title'),
                description: error.response?.data?.message || t('profile.messages.fail_desc'),
                variant: "destructive",
            });
        } finally {
            setIsUpdating(false);
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-[#FDFCF6]">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-slate-500 font-serif italic">{t('profile.loading')}</p>
                </div>
            </div>
        );
    }
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
                        <div>
                            ...
                            >
                                {isEditMode ? t('profile.edit_title') : t('profile.view_title')}
                            </motion.h1>
                        </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                        ...
                        >
                            <div className="bg-white rounded-[2.5rem] p-8 shadow-xl shadow-primary/5 border border-orange-100/50 flex flex-col items-center text-center">
                                    ...
                                    {isEditMode && (
                                        <>
                                            <button
                                                ...
                                                title={t('profile.edit.image_recommendation') || "Recommended: 500x500 px"}
                                            >
                                                <Camera className="w-5 h-5" />
                                            </button>
                                            <input type="file" ref={fileInputRef} onChange={handleFileChange} className="hidden" accept="image/*" />
                                            <p className="text-[10px] text-slate-400 mt-2 font-bold uppercase tracking-widest">{t('profile.edit.image_recommendation') || "Recommended: 500x500 px"}</p>
                                        </>
                                    )}
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4 w-full pt-6 border-t border-slate-50">
                                    <div className="text-center p-3 bg-orange-50/50 rounded-2xl">
                                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider mb-1">{t('profile.stats.rituals')}</p>
                                        <p className="text-xl font-bold text-primary">{bookings.length}</p>
                                    </div>
                                    <div className="text-center p-3 bg-orange-50/50 rounded-2xl">
                                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-wider mb-1">{t('profile.stats.sacred_items')}</p>
                            ...
                            <div className="bg-gradient-to-br from-[#88542B] to-[#794A05] rounded-[2rem] p-6 text-white shadow-xl">
                                ...
                                <h4 className="font-bold text-lg mb-1">{t('profile.status.title')}</h4>
                                <p className="text-white/70 text-sm mb-4">{t('profile.status.joined_date').replace('{{date}}', new Date(user.createdAt).toLocaleDateString())}</p>
                                    ...
                                    >
                                        <div className="space-y-10">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                                ...
                                                <div className="space-y-1.5">
                                                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest ml-1">{t('profile.fields.phone')}</p>
                                                    <div className="flex items-center gap-3 p-4 bg-slate-50 rounded-2xl border border-slate-100/50">
                                                ...
                                                <div className="space-y-1.5 md:col-span-2">
                                                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest ml-1">{t('profile.fields.email')}</p>
                                                    <div className="flex items-center gap-3 p-4 bg-slate-50 rounded-2xl border border-slate-100/50">
                                                        <Mail className="w-5 h-5 text-primary" />
                                                        <span className="text-lg font-bold text-slate-700">{user.email || t('profile.fields.no_email')}</span>
                                                    </div>
                                                </div>
                                                <div className="space-y-1.5 md:col-span-2">
                                                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest ml-1">{t('profile.fields.address')}</p>
                                                    <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-2xl border border-slate-100/50">
                                                        <MapPin className="w-5 h-5 text-primary mt-1" />
                                                        <span className="text-lg font-bold text-slate-700 leading-relaxed">{user.address || t('profile.fields.no_address')}</span>
                                                    </div>
                                                </div>
                                                <div className="space-y-1.5 md:col-span-2">
                                                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest ml-1">{t('profile.fields.native_place')}</p>
                                                    <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-2xl border border-slate-100/50">
                                                        <MapPin className="w-5 h-5 text-primary mt-1" />
                                                        <span className="text-lg font-bold text-slate-700 leading-relaxed">{user.nativePlace || t('profile.fields.no_native_place')}</span>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
                                                        {user.gothra && (
                                                            <div className="space-y-1">
                                                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1">{t('profile.fields.gothra')}</p>
                                                        ...
                                                        {user.kuldevi && (
                                                            <div className="space-y-1">
                                                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1">{t('profile.fields.kuldevi')}</p>
                                                                <div className="p-3 bg-orange-50/30 rounded-xl border border-orange-100/50">
                                                        ...
                                                        {user.kuldevta && (
                                                            <div className="space-y-1">
                                                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1">{t('profile.fields.kuldevta')}</p>
                                                                <div className="p-3 bg-orange-50/30 rounded-xl border border-orange-100/50">
                                                        ...
                                                        {user.dob && (
                                                            <div className="space-y-1">
                                                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1">{t('profile.fields.dob')}</p>
                                                                <div className="p-3 bg-orange-50/30 rounded-xl border border-orange-100/50">
                                                        ...
                                                        {user.anniversary && (
                                                            <div className="space-y-1">
                                                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1">{t('profile.fields.anniversary')}</p>
                                                                <div className="p-3 bg-orange-50/30 rounded-xl border border-orange-100/50">
                                                        ...
                                                        {user.address && (
                                                            <div className="space-y-1 md:col-span-3">
                                                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1">{t('profile.fields.delivery_address')}</p>
                                                                <div className="p-3 bg-orange-50/30 rounded-xl border border-orange-100/50">
                                            ...
                                            <div className="pt-6">
                                                <div className="flex items-center gap-3 mb-6">
                                                    ...
                                                    <h4 className="font-bold text-lg text-slate-800">{t('profile.sections.poojas')}</h4>
                                                </div>
                                                <div className="space-y-4">
                                                    {isBookingsLoading ? (
                                                                ...
                                                                <div className="flex items-center gap-4 mb-3 md:mb-0">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <p className="text-[10px] text-slate-400 mt-1 flex items-center gap-1">
                                                                            ...
                                                                            {t('profile.sections.booked_on').replace('{{date}}', new Date(booking.createdAt).toLocaleDateString(undefined, { day: 'numeric', month: 'short', year: 'numeric' }))}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div className="text-center py-12 bg-slate-50/50 rounded-3xl border border-dashed border-slate-200">
                                                            ...
                                                            <p className="text-slate-500 font-medium">{t('profile.sections.no_bookings')}</p>
                                                            <Button variant="link" className="text-primary mt-2" asChild>
                                                                <Link href="/poojas">{t('profile.sections.explore_poojas')}</Link>
                                                            </Button>
                                                        </div>
                                                    )}
                                                </div>
                                            ...
                                            <div className="pt-6">
                                                <div className="flex items-center gap-3 mb-6">
                                                    ...
                                                    <h4 className="font-bold text-lg text-slate-800">{t('profile.sections.orders')}</h4>
                                                </div>
                                                <div className="space-y-4">
                                                    {myOrders.length === 0 ? (
                                                        <div className="text-center py-10 bg-slate-50/50 rounded-3xl border border-dashed border-slate-200">
                                                            <p className="text-slate-400 text-sm">{t('profile.sections.no_orders')}</p>
                                                        </div>
                                                    ) : (
                                                        myOrders.slice(0, 3).map(order => (
                                                            <div key={order.id} onClick={() => router.push("/profile/orders")} className="flex items-center justify-between p-4 border border-slate-50 rounded-2xl hover:bg-orange-50/30 transition-colors group cursor-pointer">
                                                                <div className="flex items-center gap-4">
                                                                    ...
                                                                    <div>
                                                                        <p className="font-bold text-slate-700">{t('profile.sections.order_id_prefix')}{order.id.slice(-6).toUpperCase()}</p>
                                                                        <p className="text-xs text-slate-400">{t('profile.sections.ordered_on').replace('{{date}}', format(new Date(order.createdAt), "dd MMM, yyyy"))}</p>
                                                                    </div>
                                                                </div>
                                                ...
                                                <Button onClick={() => router.push("/profile/orders")} variant="ghost" className="w-full mt-4 text-primary font-bold group">
                                                    {t('profile.sections.view_all_activities')} <ChevronRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
                                                </Button>
                                            </div>
                                        </div>
                                    </motion.div>
                                    ...
                                    >
                                        <div className="flex items-center gap-3 mb-10">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-slate-500 text-sm">{t('profile.edit.subtitle')}</p>
                                            </div>
                                        </div>
                                        ...
                                        <form onSubmit={handleUpdate} className="space-y-8">
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                                <div className="space-y-2.5">
                                                    <Label className="text-slate-700 font-bold ml-1">{t('profile.edit.name_label')}</Label>
                                                ...
                                                <div className="space-y-2.5">
                                                    <Label className="text-slate-700 font-bold ml-1">{t('profile.edit.phone_label')}</Label>
                                                ...
                                                <div className="space-y-2.5 md:col-span-2">
                                                    <Label className="text-slate-700 font-bold ml-1">{t('profile.edit.email_label')}</Label>
                                                    <div className="relative group">
                                                ...
                                                <div className="space-y-2.5">
                                                    <Label className="text-slate-700 font-bold ml-1">{t('profile.fields.gothra')}</Label>
                                                    <Input
                                                        value={formData.gothra}
                                                        onChange={(e) => setFormData({ ...formData, gothra: e.target.value })}
                                                        placeholder={t('profile.edit.gothra_placeholder')}
                                                        className="h-14 px-6 bg-slate-50 border-slate-100 focus:bg-white focus:border-primary rounded-2xl text-lg font-medium"
                                                    />
                                                </div>
                                                <div className="space-y-2.5">
                                                    <Label className="text-slate-700 font-bold ml-1">{t('profile.fields.kuldevi')}</Label>
                                                    <Input
                                                        value={formData.kuldevi}
                                                        onChange={(e) => setFormData({ ...formData, kuldevi: e.target.value })}
                                                        placeholder={t('profile.edit.kuldevi_placeholder')}
                                                        className="h-14 px-6 bg-slate-50 border-slate-100 focus:bg-white focus:border-primary rounded-2xl text-lg font-medium"
                                                    />
                                                </div>
                                                <div className="space-y-2.5">
                                                    <Label className="text-slate-700 font-bold ml-1">{t('profile.fields.kuldevta')}</Label>
                                                    <Input
                                                        value={formData.kuldevta}
                                                        onChange={(e) => setFormData({ ...formData, kuldevta: e.target.value })}
                                                        placeholder={t('profile.edit.kuldevta_placeholder')}
                                                        className="h-14 px-6 bg-slate-50 border-slate-100 focus:bg-white focus:border-primary rounded-2xl text-lg font-medium"
                                                    />
                                                </div>
                                                <div className="space-y-2.5">
                                                    <Label className="text-slate-700 font-bold ml-1">{t('profile.fields.dob')}</Label>
                                                    <Input
                                                        type="date"
                                                        value={formData.dob}
                                                ...
                                                <div className="space-y-2.5">
                                                    <Label className="text-slate-700 font-bold ml-1">{t('profile.fields.anniversary')}</Label>
                                                    <Input
                                                        type="date"
                                                ...
                                                <div className="space-y-2.5 md:col-span-2">
                                                    <Label className="text-slate-700 font-bold ml-1">{t('profile.fields.delivery_address')}</Label>
                                                    <Input
                                                        type="text"
                                                ...
                                                <div className="space-y-2.5 md:col-span-2">
                                                    <Label className="text-slate-700 font-bold ml-1">{t('profile.fields.native_place')}</Label>
                                                    <Input
                                                        type="text"
                                                        value={formData.nativePlace}
                                                        onChange={(e) => setFormData({ ...formData, nativePlace: e.target.value })}
                                                        placeholder={t('profile.edit.native_place_placeholder')}
                                                        className="h-14 px-6 bg-slate-50 border-slate-100 focus:bg-white focus:border-primary rounded-2xl text-lg font-medium"
                                                    />
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex items-center gap-4 pt-4">
                                                ...
                                                >
                                                    {isUpdating ? <Loader2 className="w-5 h-5 animate-spin" /> : t('profile.edit.save_button')}
                                                </Button>
                                                <Button
                                                    type="button"
                                                    variant="ghost"
                        ...
                        >
                            ...
                            <div className="bg-gradient-to-r from-primary to-primary/80 p-6 md:p-8 text-white shrink-0">
                                ...
                                <div className="flex items-center gap-4 mb-2">
                                    ...
                                    <div>
                                        <h3 className="text-2xl font-serif font-bold">{t('profile.modal.title')}</h3>
                                        <p className="text-orange-100 text-sm opacity-90 uppercase tracking-widest font-medium">{t('profile.modal.subtitle')}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-6 md:p-8 space-y-8 overflow-y-auto flex-1 custom-scrollbar">
                                ...
                                <div className={`flex items-center justify-between p-4 rounded-2xl ${selectedBooking.status === 'BOOKED' ? 'bg-emerald-50 border border-emerald-100' : 'bg-orange-50 border border-orange-100'
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="font-bold text-slate-700">{t('profile.modal.status_label')}</span>
                                    </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-4">
                                        <div>
                                            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-1">{t('profile.modal.ritual_label')}</p>
                                        ...
                                        <div>
                                            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-1">{t('profile.modal.temple_label')}</p>
                                        ...
                                        <div>
                                            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-1">{t('profile.modal.date_label')}</p>
                                            <p className="text-slate-700 font-medium flex items-center gap-1.5">
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-1">{t('profile.modal.name_label')}</p>
                                    ...
                                    {(selectedBooking.gothra || selectedBooking.kuldevi || selectedBooking.kuldevta || selectedBooking.dob || selectedBooking.anniversary) && (
                                        <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 border-t pt-4">
                                            ...
                                            {selectedBooking.kuldevi && (
                                                <div>
                                                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-1">{t('profile.fields.kuldevi')}</p>
                                                    <p className="text-slate-700 font-medium">{selectedBooking.kuldevi}</p>
                                                </div>
                                            )}
                                            {selectedBooking.kuldevta && (
                                                <div>
                                                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-1">{t('profile.fields.kuldevta')}</p>
                                                    <p className="text-slate-700 font-medium">{selectedBooking.kuldevta}</p>
                                                </div>
                                            )}
                                            {selectedBooking.dob && (
                                                <div>
                                                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-1">{t('profile.fields.dob')}</p>
                                                    <p className="text-slate-700 font-medium">{format(new Date(selectedBooking.dob), "dd MMM, yyyy")}</p>
                                                </div>
                                            )}
                                            {selectedBooking.anniversary && (
                                                <div>
                                                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-1">{t('profile.fields.anniversary')}</p>
                                ...
                                <div className="pt-6 border-t border-slate-100 flex items-center justify-between">
                                    <div>
                                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">{t('profile.modal.package_label')}</p>
                                        <p className="text-slate-700 font-bold">{selectedBooking.packageName}</p>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">{t('profile.modal.offering_label')}</p>
