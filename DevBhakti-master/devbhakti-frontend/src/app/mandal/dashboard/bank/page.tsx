...
import { fetchMandalBankDetails, updateMandalBankDetails } from "@/api/mandalBankController";

export default function MandalBankDetailsPage() {
    ...
    const loadBankDetails = async () => {
        try {
            const response = await fetchMandalBankDetails();
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await updateMandalBankDetails(payload);

            if (response.success) {
                toast({
                    title: "Success",
                    description: response.message || "Bank details saved successfully.",
                });
            } else {
        ...
        <div className="max-w-4xl mx-auto space-y-8 pb-12">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-slate-500 text-sm font-medium">
                        Manage your Mandal bank account for receiving payouts.
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        placeholder="e.g. Mandal Trust Account"
                                        className="h-12 pl-11 rounded-xl bg-slate-50 border-slate-200 focus:bg-white transition-all font-bold text-slate-900 placeholder:text-slate-400"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className="h-12 pl-11 rounded-xl bg-slate-50 border-slate-200 focus:bg-white transition-all font-mono font-bold text-slate-900 placeholder:text-slate-400"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-3">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input
                                            ...
                                            className="h-12 pl-11 rounded-xl bg-slate-50 border-slate-200 focus:bg-white transition-all font-mono uppercase font-bold text-slate-900 placeholder:text-slate-400"
                                            maxLength={11}
                                        />
                                    </div>
                                </div>
                                <div className="space-y-3">
                                    ...
                                    <Input
                                        ...
                                        className="h-12 rounded-xl bg-slate-50 border-slate-200 focus:bg-white transition-all font-bold text-slate-900 placeholder:text-slate-400"
                                    />
                                </div>
                            </div>
                    ...
                    <div className="flex justify-end">
                        <Button
                            onClick={handleSave}
                            disabled={isSaving}
                            className="bg-orange-600 hover:bg-orange-700 text-white rounded-xl h-12 px-8 font-bold shadow-lg shadow-orange-600/20 flex items-center gap-2 transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                ...
                <div className="space-y-6">
                    <Card className="border-none shadow-lg rounded-[2rem] bg-gradient-to-br from-orange-600 to-amber-700 text-white">
                    ...
                    <div className="bg-amber-50 rounded-[1.5rem] p-6 border border-amber-100 flex gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-amber-800/80 font-medium leading-relaxed">
                                Please ensure that the Mandal bank account details provided are correct. DevBhakti is not responsible for payouts made to incorrect accounts.
                            </p>
                        </div>
                    </div>
                </div>
