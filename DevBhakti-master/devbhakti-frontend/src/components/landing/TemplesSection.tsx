      ...
      <div className="container mx-auto px-4 relative z-10 mt-3">
        ...
        >
          <div>
            <span className="text-primary font-medium text-sm uppercase tracking-wider">
              {t('landing.temples.subtitle')}
            </span>
            <h2 className="text-2xl md:text-3xl font-serif font-bold text-foreground mt-1">
              {t('landing.temples.title1')}
              <span className="text-gradient-sacred">{t('landing.temples.title2')}</span>
            </h2>
            <p className="text-sm text-foreground mt-1">
              {t('landing.temples.description')}
            </p>
          </div>
                    ...
                    <div className="bg-card rounded-2xl overflow-hidden border-2 border-border/50 shadow-soft hover:shadow-warm transition-all duration-300 hover:-translate-y-2 h-full flex flex-col">
                      ...
                      <div className="relative h-40 md:h-44 overflow-hidden">
                        ...
                        <div className="absolute top-4 left-4">
                          <Badge variant="secondary">{getLocalized(temple, 'category', language)}</Badge>
                        </div>
                      </div>
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-border/40 mt-auto">
                          <div className="flex flex-col gap-1">
                            <div className="flex items-center gap-1 text-muted-foreground">
                              ...
                              <span className="text-[10px] line-clamp-1">{getLocalized(temple, 'location', language)}</span>
                            </div>
                            {showRatings && (
                          ...
                          <div className="flex flex-col items-end gap-1">
                            ...
                            >
                              {t('landing.temples.explore')} <ArrowRight className="w-3 h-3 ml-1" />
                            </Button>
                          </div>
                        </div>
                      </div>
        ...
        <div className="text-center mt-1">
          <Button variant="outline" className="rounded-full border-[#88542B] text-[#88542B] hover:bg-[#88542B] hover:text-white" asChild>
            <Link href="/temples">
              {t('landing.temples.view_all_temples')} <ArrowRight className="w-4 h-4 ml-2" />
            </Link>
          </Button>
        </div>
      </div>
