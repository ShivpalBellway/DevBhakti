...
export function ImageCropper({
    ...
    const ASPECT_RATIOS = [
        { label: t("image_cropper.ratios.free"), value: 0 },
        { label: "1:1", value: 1 / 1 },
        { label: "3:2", value: 3 / 2 },
        { label: "4:3", value: 4 / 3 },
        { label: "5:4", value: 5 / 4 },
            ...
            <DialogContent className="max-w-7xl h-[95vh] flex flex-col p-0 overflow-hidden bg-[#FAF9F7] border-none shadow-2xl rounded-3xl">
                ...
                <DialogHeader className="p-6 border-b border-[#E8E2D9] bg-white flex flex-row items-center justify-between shrink-0">
                    <div className="flex flex-col gap-1">
                        ...
                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest pl-11">{t("image_cropper.version_info")}</p>
                    </div>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    <span className="text-[10px] font-black text-[#5C4D3F] uppercase tracking-[0.2em] flex items-center gap-2">
                                        <CropIcon className="w-3.5 h-3.5 text-primary" /> {t("image_cropper.aspect_ratio")}
                                    </span>
                                </div>
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-2">
                            <div className="flex items-center gap-8">
                                ...
                                <div className="flex flex-col gap-2">
                                    <p className="text-[10px] font-black uppercase tracking-widest text-[#5C4D3F]/60 ml-1">{t("image_cropper.modes.selection_mode")}</p>
                                    <div className="flex gap-2">
                                        <Button 
                                            ...
                                            title={t("image_cropper.modes.adjust_box")}
                                        >
                                            <div className="flex items-center gap-2">
                                                <CropIcon className="w-4 h-4" />
                                                <span className="text-[10px] font-bold">{t("image_cropper.modes.adjust_box")}</span>
                                            </div>
                                        </Button>
                                        <Button 
                                            ...
                                            title={t("image_cropper.modes.move_image")}
                                        >
                                            <div className="flex items-center gap-2">
                                                <Move className="w-4 h-4" />
                                                <span className="text-[10px] font-bold">{t("image_cropper.modes.move_image")}</span>
                                            </div>
                                        </Button>
                                    </div>
                                </div>
                                ...
                                {/* Rotation Group */}
                                <div className="flex flex-col gap-2">
                                    <p className="text-[10px] font-black uppercase tracking-widest text-[#5C4D3F]/60 ml-1">{t("image_cropper.rotation")}</p>
                                    <div className="flex gap-2">
                                ...
                                {/* Zoom Group */}
                                <div className="flex flex-col gap-2">
                                    <p className="text-[10px] font-black uppercase tracking-widest text-[#5C4D3F]/60 ml-1">{t("image_cropper.scaling")}</p>
                                    <div className="flex gap-2">
                                ...
                                <div className="hidden xl:flex items-center gap-4 bg-white/50 px-4 py-2 rounded-xl border border-dashed border-slate-200 text-slate-400 text-[10px] font-medium transition-all">
                                    <div className="flex items-center gap-2 border-r border-slate-200 pr-3">
                                        ...
                                        {t("image_cropper.tips.handles")}
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <Move className="w-3 h-3" />
                                        {dragMode === 'move' ? t("image_cropper.tips.dragging") : t("image_cropper.tips.click_draw")}
                                    </div>
                                </div>
                            </div>
                            ...
                            >
                                {isLoading ? (
                                    ...
                                    <>
                                        ...
                                        <span>{t("image_cropper.finalize_btn")}</span>
                                    </>
                                )}
                            </Button>
                        </div>
