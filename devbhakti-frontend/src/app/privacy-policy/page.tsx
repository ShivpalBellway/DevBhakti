        ...
        <main className="min-h-screen bg-background">
            ...
            <section className="relative pt-32 pb-16 bg-gradient-sacred text-white overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    ...
                    >
                        This Privacy Policy describes how personal information is collected, used, and protected on the DevBhakti Platform. DevBhakti is owned and operated by <span className="font-bold">Divinity Labs Private Limited</span> (“Company”, “we”, “our”, or “us”).
                    </motion.p>
                </div>
            </section>
