...
export default function EditInstitutionPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await updateInstitutionAdmin(instId, fd);
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-6 pb-20">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-slate-900 font-serif">Edit Temple Institution</h1>
                    <p className="text-muted-foreground">Modify organizational and temple profile details.</p>
                </div>
            </div>
