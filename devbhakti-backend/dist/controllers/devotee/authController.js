...
exports.getProfile = exports.updateProfile = exports.verifyOTP = exports.sendOTP = void 0;
...
const verifyOTP = async (req, res) => {
    try {
        ...
        // Generate JWT
        const token = jsonwebtoken_1.default.sign({ userId: updatedUser.id, phone: updatedUser.phone, role: updatedUser.role }, JWT_SECRET, { expiresIn: '7d' });
        res.json({
            success: true,
