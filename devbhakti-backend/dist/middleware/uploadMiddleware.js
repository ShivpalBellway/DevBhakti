...
exports.uploadCategoryImage = exports.uploadProductImage = exports.uploadUserImage = exports.uploadCmsTestimonial = exports.uploadCmsImage = exports.uploadPoojaImage = void 0;
...
exports.uploadCategoryImage = (0, multer_1.default)({
    storage: multer_1.default.diskStorage({
        ...
        filename: (req, file, cb) => {
            const uniqueSuffix = Date.now() + '-' + Math.round(Math.random() * 1E9);
            cb(null, 'category-' + uniqueSuffix + path_1.default.extname(file.originalname));
        }
    }),
    fileFilter: fileFilter,
