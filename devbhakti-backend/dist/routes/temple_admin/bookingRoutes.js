...
const availabilityController_1 = require("../../controllers/temple_admin/availabilityController");
...
// Availability Routes
router.post('/availability', availabilityController_1.setAvailability);
